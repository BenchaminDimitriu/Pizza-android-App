    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            ...
            case R.id.menu:
                ...
                Intent l = new Intent(profile.this, menu.class);
                startActivity(l);
                return true;
            case R.id.coupons:
                Toast.makeText(this, "Coupon is selected", Toast.LENGTH_SHORT).show();
                Intent e = new Intent(profile.this, coupons.class);
                startActivity(e);
                return true;
            case R.id.location:
                Toast.makeText(this, "Location is selected", Toast.LENGTH_SHORT).show();
                Intent a = new Intent(profile.this, location.class);
                startActivity(a);
                return true;
            case R.id.contact:
            ...
            case R.id.music:
                ...
                Intent f = new Intent(profile.this, musicController.class);
                startActivity(f);
                return true;
            case R.id.logout:
