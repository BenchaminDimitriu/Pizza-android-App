    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.home:
                ...
                Intent k = new Intent(cart.this, MainActivity.class);
                startActivity(k);
                return true;
            case R.id.profile:
