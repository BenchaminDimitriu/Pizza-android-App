...
public class RecyclerViewAdapterCoupon extends RecyclerView.Adapter<RecyclerViewAdapterCoupon.ViewHolder>{
    ...
    public RecyclerViewAdapterCoupon(ArrayList<String> mUser, ArrayList<String> mTitle, ArrayList<String> mTime, ArrayList<String> mDescription, Context mContext) {
        this.mUser = mUser;
        this.mTitle = mTitle;
        this.mTime = mTime;
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterCoupon.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_child_coupon, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterCoupon.ViewHolder holder, int position) {
