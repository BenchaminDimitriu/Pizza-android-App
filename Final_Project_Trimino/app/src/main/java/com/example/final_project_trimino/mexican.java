...
public class mexican extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mexican = findViewById(R.id.mexicanTxt);
        ...
        orderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pizza.setPizzaBType((mexican.getText().toString().trim()));
                reference.child(String.valueOf(i+1)).setValue(pizza);

                Intent i = new Intent(mexican.this, CartActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.home:
                ...
                Intent k = new Intent(mexican.this, MainActivity.class);
                startActivity(k);
                return true;
//            case R.id.profile:
